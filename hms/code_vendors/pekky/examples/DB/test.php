<?php
 ...
 $dbq->set_fetch_mode("assoc");//read on this method in th query file

 /** NOTE THE get(), change(),add(),remove() function return bool, true if successful, false otherwise
  */
 ...
 $dbq->get_row_count();//checking how many rows returned like mysql_num_rows

$dbq->get_err_msg();//stores error messages if an error occured
